...
var appointmentsPortal_controller = require('../controllers/appointmentsPortal_controller');
var isAuthenticated = require("../config/middleware/isAuthenticated");

router.get('/', isAuthenticated, appointmentsPortal_controller.index);
...
router.post('/new', appointmentsPortal_controller.makeAppointment);
